<template>
        ...
        <p>If you do not agree with (or cannot comply with) Agreements, then you may not use the Service, but please let
            us know by emailing at <b>system@frd.app</b> so we can try to find a solution. These Terms apply to all
        ...
        <p>By using our Service, you agree to subscribe to newsletters, marketing or promotional materials and other
            ...
            by following the unsubscribe link or by emailing at system@frd.app.</p>
        <p>3. <b>Purchases</b></p>
        ...
        <p>At the end of each Billing Cycle, your Subscription will automatically renew under the exact same conditions
            ...
            through your online account management page or by contacting system@frd.app customer support team.</p>
        ...
        <p>If you are a copyright owner, or authorized on behalf of one, and you believe that the copyrighted work has
            ...
            system@frd.app, with the subject line: “Copyright Infringement” and include in your claim a detailed
        ...
        <p>You can contact our Copyright Agent via email at system@frd.app.</p>
        <p>17. <b>Error Reporting and Feedback</b></p>
        <p>You may provide us either directly at system@frd.app or via third party sites and tools with information and
        ...
        <p>Please send your feedback, comments, requests for technical support by email: <b>system@frd.app</b>.</p>
