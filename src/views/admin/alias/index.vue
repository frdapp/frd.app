            ...
            <Table :items="items" 
                ...
                <Column  :label="$t('Operate')" style="width:300px"> 
                    <template #default="scope">
                        ...
                        <a :href="'/admin/alias/update?id='+scope.item.id"  style="margin-left:0px" class="link-primary decoration_none" >{{$t("Edit")}}</a>
    ...
    openAddDialog:function(){
       ...
       return ;
        ...
        search:async function(){
            var response=await this.$api.admin_alias_list(this.query)
