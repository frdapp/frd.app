...
export default {
    ...
    openEditDialog:function(item_id){
            this.$router.push({ path: "/manage/storage/update", query: {  "id":item_id}} ) ;
    ...
    openDeleteDialog:async function(id,title){
            ...
            if(result)
            {
                var response=await this.$api.manage_storage_delete({"id":id})
                if(response != false)
                {
                    this.search()
                }
    ...
    openAddDialog:function(){
       ...
       return ;
        ...
        search:async function(){
            var response=await this.$api.manage_storage_list(this.query)
