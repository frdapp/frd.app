        ...
        <HBox  style="  margin-top:10px;padding:0px;">
            ...
            <div  style="margin-top:10px;padding:0px;width:100%">
                    <Table :items="items"
                        ...
                        <Column prop="active" :label="$t('Active')" width="100"> </Column>
...
export default {
    ...
    methods:{
        openViewDialog:function(item_id){
            this.$router.push({ path: '/manage/email/view', query: {"id":item_id }} ) ;
            return
        },

    openEditDialog:function(item_id){
            this.$router.push({ path: "/manage/email/update", query: {  "id":item_id}} ) ;

            return ;
    },
    openDeleteDialog:async function(id,title){
            let url="/api/manage/email/delete?id="+id
    ...
    openAddDialog:function(){
       ...
       return ;
        ...
        search:async function(){
            var response=await this.$api.manage_email_list(this.query)
